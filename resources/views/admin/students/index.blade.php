        ...
        <div class="filter row mb-4">
            ...
            <div class="col-6 col-md-2">
                <div class="d-flex align-items-center gap-1">
                    <span>{{ __('Show') }}</span>
                    {!! Form::select('size', [10 => 10, 50 => 50, 200 => 200, 500 => 500, 1000 => 1000, 2000 => 2000, 3000 => 3000], request('size'), ['class' => 'form-select', 'id' => 'pagination']) !!}
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        {!! Form::open(['url' => route('students.import'), 'method' => 'POST', 'id' => 'importExcelForm', 'class' => 'mt-2']) !!}
